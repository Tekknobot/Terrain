...
var quotes = [
	...
	"Sync ratio at one hundred percent lets do this.",
	...
	"Piloting my EVA suit like its my second skin.",
	...
	"Cant stop wont stop until every kaiju hits the floor.",
	...
	"Calibrating servos lets show them what precision feels like.",
	...
	"Activate stealth mode now you see us now you dont.",
	...
	"Pulse drive engaged lets outrun those giant bots.",
	...
	"Engineering marvel meets combat prowess lets roll.",
